    ...
    a.MixItUp.prototype = {
        ...
        _init: function (f, d) {
            ...
            if (c.controls.toggleFilterButtons) {
                ...
                for (var e = 0; e < c._toggleArray.length; e++) {
                    c._updateControls({ filter: c._toggleArray[e], sort: c._activeSort }, true);
                }
            } else {
        ...
        _getTargetData: function (f, d) {
            ...
            if (c.animation.animateResizeTargets) {
                e = !c._suckMode ? window.getComputedStyle(f) : { marginBottom: "", marginRight: "" };
        ...
        _getOrigMixData: function () {
            var d = this,
                g = !d._suckMode ? window.getComputedStyle(d._$parent[0]) : { boxSizing: "" },
        ...
        _prepTargets: function () {
            var c = this,
                d = { _in: c._getPrefixedCSS("transform", c.effects.transformIn), _out: c._getPrefixedCSS("transform", c.effects.transformOut) };
            ...
            for (var f = 0; f < c._$pre.length; f++) {
                var g = c._$pre[f],
                    e = a(g),
                    h = { x: g.dataset.origPosX - g.dataset.interPosX, y: g.dataset.origPosY - g.dataset.interPosY },
        ...
        _animateTargets: function () {
            ...
            for (var f = 0; f < m._$toShow.length; f++) {
                var c = m._$toShow[f],
                    n = a(c),
                    d = { x: c.dataset.finalPosX - c.dataset.interPosX, y: c.dataset.finalPosY - c.dataset.interPosY },
                    g = m._getDelay(f),
                    k = {};
                c.style.opacity = "";
                for (var e = 0; e < 2; e++) {
        ...
        _parseInsertArgs: function (f) {
            var e = this,
                d = { index: 0, $object: a(), multiMix: { filter: e._state.activeFilter }, callback: null };
            for (var g = 0; g < f.length; g++) {
                var c = f[g];
                if (typeof c === "number") {
                    d.index = c;
